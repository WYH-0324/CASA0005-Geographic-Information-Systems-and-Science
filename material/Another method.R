...
# read csv data
data<-read.csv("/D：/Desktop/USS-2024/CASA0005-Geographic Information Systems and Science/week 4/HDR23-24_Composite_indices_complete_time_series.csv")
...
# read GeoJSON data
geo_data <- st_read("/Users/D:/Desktop/USS-2024/CASA0005-Geographic Information Systems and Science/week 4/World_Countries_(Generalized)_9029012925078512962.geojson")
